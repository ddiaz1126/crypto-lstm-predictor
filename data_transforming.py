...
def fetch_and_process_stock_data(input_path, output_path, look_back=5):
    import pandas as pd
    import numpy as np
    ...
    # Get the last 5 'Close_Diff' values and save
    last_5_diff_values = test_diff.values[-look_back:].reshape(1, 5)
    np.save(output_path, last_5_diff_values)
